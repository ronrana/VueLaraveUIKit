      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="button-container">
          <div class="">
            ...
            >
              <i class="fas fa-download"></i>Purchase now</a
            >
        ...
        <li class="button-container">
          <social-sharing
            :url="shareUrl"
            inline-template
            title="Vue Now UI Dashboard PRO - Premium Bootstrap Admin Template for Vue.js"
...
export default {
  ...
  data() {
    return {
      documentationLink:
        "https://vue-now-ui-dashboard-pro-laravel.creative-tim.com/documentation/#/getting-started",
      ...
      gitLink:
        "https://github.com/creativetimofficial/ct-vue-now-ui-dashboard-pro-laravel",
      isOpen: false,
      sidebarColors: [
